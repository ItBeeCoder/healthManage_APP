 ...
 *2018年1月26日下午2:44:38
 */
public class BreathnearmonthWave extends Activity {
...
//			}
	...
	private void getConfirmData(){
		...
		String selectDate = format.format(new java.util.Date());
		...
		params.add(new BasicNameValuePair("breathDateTime",selectDate));
		
		myurl = Constants.SERVER_HOST+"/getPrenightByOldAndDate.action";	
	...
	private final class StopBtn implements OnClickListener {
		@Override
		public void onClick(View arg0) {
			BreathnearmonthWave.this.finish();
		}
	}
