 ...
 *2018年1月28日下午5:26:50
 */
public class BreathNearmonthChoice extends Activity {
	...
	private final class ClickListener implements OnClickListener{
		...
		public void onClick(View v) {
			...
			case R.id.heart_page_back:
				BreathNearmonthChoice.this.finish();
				break;
			default:
				break;
			}
		...
		private void GotoHeartMaxchart(){
			...
			intent.setClass(getApplicationContext(),BreathNightMaxWave.class);
		...
		private void GotoHeartMinchart(){
			Intent intent= new Intent();
			intent.putExtra("oldmanAccount",OldmanAccount);
			intent.setClass(getApplicationContext(),BreathNightMinWave.class);
			startActivity(intent);
		}
		//此处需要改
		private void GotoHeartAvgchart(){
			Intent intent= new Intent();
			intent.putExtra("oldmanAccount",OldmanAccount);
			intent.setClass(getApplicationContext(),BreathNightAvgWave.class);
			startActivity(intent);
		}
}
