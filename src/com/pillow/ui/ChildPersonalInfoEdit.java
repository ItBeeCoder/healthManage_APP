 ...
 *2018年1月28日下午1:17:48
 */
public class ChildPersonalInfoEdit extends Activity {
...
protected void onCreate(Bundle savedInstanceState) {
	...
	setContentView(R.layout.child_pserson_info_edit);
...
//			addUserPersonalInfo();
	...
	case R.id.userPersonal_info_page_back:
		returnToPriview();
		ChildPersonalInfoEdit.this.finish();
		break;
		default:
			break;
		}
...
//			将在APP端填写的用户信息传递给服务器
		Constants.requestUrl = Constants.SERVER_HOST+"/updChildPerInfo.action";
...
//							如果用户信息添加成功，则返回上一页面，同时结束当前活动
							Toast.makeText(getApplicationContext(), "信息编辑成功",Toast.LENGTH_LONG).show();
							Intent intent = new Intent();
							intent.putExtra("usertype",usertype);
							setResult(RESULT_OK,intent);
							ChildPersonalInfoEdit.this.finish();
